package ro.tekin.jpa.exam.example;
...
public class Employee2 {
    @Id
    @TableGenerator(name="Emp_Gen", table = "ID_GEN", pkColumnName = "GEN_NAME", valueColumnName = "GEN_VAL", initialValue = 0 /*default*/, allocationSize = 50 /*default*/ /*,pkColumnValue = the name that will appear in the pkColumnName column; default is the generator name*/)
